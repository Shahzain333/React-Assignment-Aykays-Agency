...
function About() {
  ...
  return (
    ...
    <section className='flex flex-col lg:flex-row items-center justify-center px-2 pb-6'>
        ...
        <div className='lg:w-1/2 p-2 sm:p-10 lg:p-0'>
            <h1 className='text-[#282722] text-4xl lg:text-6xl font-semibold'>Where Every Click Sparks a Connection!</h1>
            <p className='text-[#222222] text-[12px] sm:text-[16px] pt-4 max-w-[80%]'>A small act of kindness today can create a lifetime of impact for someone in need. Give from the heart and change a life!</p>
        
            <div className="grid grid-cols-1 gap-2 pt-4 lg:w-[80%]">
